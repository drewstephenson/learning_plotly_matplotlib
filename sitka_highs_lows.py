...
for row in reader:
    ...
    high = int(row[4])  # each line is treated as a list with each comma separated value as an element
    low = int(row[5])
...
# Format plot
plt.title("2021 Daily High and Low Temperatures in Sitka, Alaska", fontsize=20)
