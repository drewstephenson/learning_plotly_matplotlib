This is an example of a generated random walk map, green is the start and red is the end. The movements are random, so the map will look different each time the program is ran.
